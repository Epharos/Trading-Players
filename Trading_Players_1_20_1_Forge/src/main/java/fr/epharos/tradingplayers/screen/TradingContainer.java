...
public class TradingContainer extends AbstractContainerMenu 
{
	...
	{		
		DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> {
			...
			{
				PacketHandler.INSTANCE.sendToServer(new PacketUpdateTradingStateServer((byte) 1));
			}
		});
	...
	public void removed(Player player) 
	{
		...
		if(player instanceof ServerPlayer sp)
		{
			...
			PacketHandler.INSTANCE.send(PacketDistributor.PLAYER.with(() -> sp), new PacketUpdateTradingStateClient((byte) 2));
		}
	}
